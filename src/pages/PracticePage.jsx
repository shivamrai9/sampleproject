...
const PracticePage = () => {
    return (
        <>
            ...
            <div class="bg-white flex justify-center items-center h-screen border">
                <div class="w-2/5 relative h-screen hidden lg:block bg-[#f6dc92]">
                    ...
                    <img src="your-image.png" alt="Your Image" class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2" />
                </div>

                <div class=" w-full lg:w-3/5 h-full flex flex-col p-8  lg:justify-between">
            ...
            <footer class="bg-white">
                <div class="mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
                    <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
                        ...
                        <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:col-span-2 lg:grid-cols-5">
                            <div>

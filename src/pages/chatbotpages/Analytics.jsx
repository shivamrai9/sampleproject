...
const Analytics = () => {
    return (
        <>
            <div class="sm:p-10 p-5 lg:px-10 bg-gray-100">
                <div class="max-w-full mx-auto  justify-items-center grid md:grid-cols-2 lg:grid-cols-4 gap-x-14 gap-y-5">
                    <div class="w-full bg-white shadow-lg h-36 p-4 flex flex-col justify-end  order-1 md:col-start-1 md:col-end-1 md:max-w-xs lg:order-none">
                    ...
                    {/* <div class="w-full border-slate-900 border bg-white shadow-lg h-80 p-4  order-1 md:col-start-1 md:col-end-1 md:max-w-xs lg:order-none">

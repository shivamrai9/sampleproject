            ...
            <div className="flex flex-col items-start justify-start pt-10 pr-10 pb-10 pl-10 bg-white shadow-2xl rounded-xl relative z-10">
              ...
              <form className="w-full mt-6 mr-0 mb-0 ml-0 relative space-y-8" onSubmit={handleSubmit}>
                ...
                <div className="flex justify-center">
                  <Link className="bg-green-500 relative rounded py-1.5 px-2 mt-4 text-white transform hover:scale-105 text-center" to="/signup">Don't have an account? Sign Up</Link>
                </div>
              </form>
            </div>
          </div>
